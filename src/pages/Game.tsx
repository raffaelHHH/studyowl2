...
import { ArrowLeft, Trophy, Star, Home, Info, MapPin } from "lucide-react";
...
const Game = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      {/* QR Scanner overlay + big View Map button */}
      {showQRScanner && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background/95 backdrop-blur-sm">
          ...
          {/* Large View Map button below scanner */}
          <Button
            type="button"
            size="lg"
            onClick={() => navigate('/map')}
            className="mt-6 w-full max-w-md mx-auto py-4 rounded-full text-base font-bold bg-accent text-background hover:scale-[1.02] transition-transform flex items-center justify-center gap-2"
          >
      ...
      {gameStarted && (
        <div className="container mx-auto max-w-4xl py-8 px-4">
          ...
          <div className="mb-8">
            <div className="text-center mb-4">
              <h2 className="text-xl md:text-2xl font-bold text-accent">
                ...
                <span className="text-accent">{targetWord}</span>
              </h2>
            </div>
            <LetterCollector
            ...
            <div className="w-full bg-muted rounded-full h-3 mb-2">
              <div
                ...
                style={{
                  width: `${
                    (collectedLetters.length / targetWord.length) * 100
                  }%`,
                }}
              />
            </div>
          ...
          {!isGameComplete ? (
            ...
            <GameCard
              variant="success"
              className="text-center max-w-2xl mx-auto border-2 border-success/30"
            >
              <div className="space-y-6">
                ...
                <p className="text-xl text-foreground">
                  You successfully spelled{" "}
                  <span className="font-bold text-accent">{targetWord}</span>!
                </p>
                <p className="text-lg text-muted-foreground">
                  Final Score:{" "}
                  <span className="font-bold text-accent">{score} points</span>
                </p>
                <Button
